...
# 2 "hello.c" 2
//This is where <stdio.h>'s content ends and my file resumes





// the ifdef gets expanded here, because FOO was defined it is getting printed
# 8 "hello.c"
...
int main(void)
{
  // Our HELLO(FOO) got expanded here
  printf("HELLO" "FOO");
}
